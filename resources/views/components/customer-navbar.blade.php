        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="languageDropdown">
          ...
          <a class="dropdown-item" href="{{ route('sys.changeLanguage', ['locale' => 'en']) }}">
            <div class="item-content d-flex align-items-center p-0">
              ...
              <h6 class="ellipsis font-weight-normal mb-0">Английский</h6>
            </div>
          </a>
        </div>
      </li>
        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="messageDropdown">
          ...
          <a class="dropdown-item">
            <div class="item-thumbnail">
              <img src="{{ asset('assets/dashboard/images/faces/face4.jpg') }}" alt="image" class="profile-pic">
            </div>
          ...
          <a class="dropdown-item">
            <div class="item-thumbnail">
              <img src="{{ asset('assets/dashboard/images/faces/face2.jpg') }}" alt="image" class="profile-pic">
            </div>
            <div class="item-content flex-grow">
          ...
          <a class="dropdown-item">
            <div class="item-thumbnail">
              <img src="{{ asset('assets/dashboard/images/faces/face3.jpg') }}" alt="image" class="profile-pic">
            </div>
            <div class="item-content flex-grow">
