  ...
  <div class="row">
    <div class="col-md-12 grid-margin">
      <div class="d-flex align-items-center">
        ...
        <p class="text-muted mb-0 hover-cursor mr-2"> / </p>
        <p class="text-primary mb-0 hover-cursor">{{ __('Processing') }}</p>
      </div>
    </div>
    <div class="col-md-12 grid-margin d-flex justify-content-between">
      <div>
        <h2>{{ __('Orders in your processing') }}</h2>
        <p class="mb-md-0">
          {{ __('List of orders that you have accepted for processing') }}
        </p>
      </div>
      <div>
    ...
    @else
      <div class="col-12">
        ...
        <a class="btn btn-sm btn-outline-primary" href="#">{{ __('Orders in my processing') }}</a>
      </div>
    @endif
  </div>
@endsection
